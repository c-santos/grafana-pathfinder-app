...
export const PERMANENT_TAB_IDS = new Set(['recommendations', 'devtools', 'editor', 'llm']);

/**
 * Computes which tabs fit in the visible area and which move to overflow.
 * Permanent tabs (recommendations, devtools, editor, llm) are always in visibleTabs;
